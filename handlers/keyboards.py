...
homework_back_n_keyboard = types.InlineKeyboardMarkup()
homework_back_n_keyboard.row(types.InlineKeyboardButton('🔙', callback_data='schedule'))

homework_back_t_keyboard = types.InlineKeyboardMarkup()
homework_back_t_keyboard.row(types.InlineKeyboardButton('🔙', callback_data='next'))

next_keyboard = types.InlineKeyboardMarkup()
next_keyboard.row(types.InlineKeyboardButton('🔙', callback_data='back'),
                  types.InlineKeyboardButton('📚', callback_data='homework_n'),
                  types.InlineKeyboardButton('→', callback_data='next'))

today_keyboard = types.InlineKeyboardMarkup()
today_keyboard.row(types.InlineKeyboardButton('←', callback_data='schedule'),
                   types.InlineKeyboardButton('📚', callback_data='homework_t'))
...
# schedule_keyboard.row(types.InlineKeyboardButton('Предыдущий', callback_data='yesterday'),
#                       types.InlineKeyboardButton('Следующий', callback_data='tomorrow'))
schedule_keyboard.row(types.InlineKeyboardButton('🔙', callback_data='back'))

main_menu_keyboard = types.InlineKeyboardMarkup()
main_menu_keyboard.row(types.InlineKeyboardButton(text="Расписание", callback_data='schedule'),
